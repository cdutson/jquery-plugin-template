...
(function ($) {
    ...
    jQuery.fn.myPlugin = function (options, i) {
        ...
        this.Create = function (iteration) {
            ...
            if ($(container).attr('data-' + pluginName) === true) return this;

            // Call a function before you do anything
            if (opts.beforeCreateFunction !== null && $.isFunction(opts.beforeCreateFunction)) opts.beforeCreateFunction(targetSection, opts);
            ...
            if (opts.afterCreateFunction !== null && $.isFunction(opts.afterCreateFunction)) opts.afterCreateFunction(targetSection, opts);
            return $(this);
        };
